...
- (void)generatePreviewImage:(void (^ _Nonnull)(NSImage * _Nullable, NSError * _Nullable))completionHandler;
...
- (void)deviceDidChangeName:(ICDevice * _Nonnull)device;
...
SWIFT_ENUM_FWD_DECL(NSInteger, ReachabilityStatus)
...
@interface WiFiReachability (SWIFT_EXTENSION(CascableCore)) <CWEventDelegate>
